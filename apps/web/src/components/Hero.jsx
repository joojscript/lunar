      ...
      <div className="w-full md:w-[800px] xl:w-[900px] flex flex-col justify-center items-center pt-10 md:pt-12 lg:pt-16 text-center">
        ...
        >
          <div className="text-5xl sm:text-6xl lg:text-7xl xl:text-7xl font-bold tracking-wide  text-white  px-8 sm:px-8 md:px-20 lg:px-4">
            ...
            <span className="hidden md:inline">Explore o futuro</span>
          </div>
          <div className="mt-2 sm:mt-2 text-4xl sm:text-6xl lg:text-7xl xl:text-7xl font-bold tracking-wide  text-white  px-8 sm:px-20 md:px-24 lg:px-24">
            da segurança de redes
          </div>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
        ...
        >
          <div className="text-customGrayText text-sm lg:text-base xl:text-lg sm:text-base mt-10 px-12 sm:px-48 ">
            Transforme a maneira como você enxerga a segurança digital. 
            Conheça o Lunar, seu aliado na defesa contra ameaças em ambientes distribuídos.
          </div>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
